...
namespace QLCF
{
    public partial class frmIncome : Form
    {
        ...
        BusinessLayer.User quantri = new BusinessLayer.User();
        ...
        public void email_send(DateTime ngay)
        {
            ...
            try
            {
                ...
                mail.Subject = "[HOIAN]-GANESH RESTAURANT - DAILY  REPORT - '" + ngay.Date.ToShortDateString() + "'";
                mail.Body = "[HOIAN]-GANESH RESTAURANT - DAILY REPORT - '" + ngay.Date.ToShortDateString() + "'";
